  ...
  <BrowserRouter>
    <Routes>
      ...
      <Route element={<ProtectedRoute allowedRoles={ALL}><AppShell /></ProtectedRoute>}>
        ...
        {/* Appointments */}
        <Route path={ROUTES.APPOINTMENTS}          element={<Navigate to={ROUTES.APPOINTMENT_SCHEDULER} replace />} />
        <Route path={ROUTES.APPOINTMENT_SCHEDULER} element={<Scheduler />} />
        <Route path={ROUTES.MANAGE_WAITING_LIST}   element={<ManageWaitingList />} />
        <Route path={ROUTES.APPOINTMENT_CONTROL}   element={<AppointmentControl />} />
        <Route path={ROUTES.SUPERBILL_BATCH_PRINT} element={<SuperbillBatchPrint />} />
        <Route path={ROUTES.APPOINTMENT_CONFIG}    element={<AppointmentConfig />} />

        {/* Patient */}
        <Route path={ROUTES.PATIENT}               element={<Navigate to={ROUTES.PATIENT_MAIN} replace />} />
        ...
        <Route path={ROUTES.STATEMENT_BATCH_PRINT} element={<StatementBatchPrint />} />
        ...
        {/* Claim */}
        <Route path={ROUTES.CLAIM}             element={<Navigate to={ROUTES.CLAIM_MAIN} replace />} />
        ...
        <Route path={ROUTES.PRACTICES}           element={<ProtectedRoute allowedRoles={ADMIN}><Practices /></ProtectedRoute>} />
        <Route path={ROUTES.PROVIDERS}           element={<ProtectedRoute allowedRoles={ADMIN}><Providers /></ProtectedRoute>} />
        <Route path={ROUTES.FACILITIES}          element={<ProtectedRoute allowedRoles={ADMIN}><Facilities /></ProtectedRoute>} />
        <Route path={ROUTES.REFERRING_PROVIDERS} element={<ProtectedRoute allowedRoles={ADMIN}><ReferringProviders /></ProtectedRoute>} />
        <Route path={ROUTES.PAYERS}              element={<ProtectedRoute allowedRoles={ADMIN}><Payers /></ProtectedRoute>} />
        <Route path={ROUTES.PAYER_AGREEMENTS}    element={<ProtectedRoute allowedRoles={ADMIN}><PayerAgreements /></ProtectedRoute>} />
        <Route path={ROUTES.COLLECTION_AGENCIES} element={<ProtectedRoute allowedRoles={ADMIN}><CollectionAgencies /></ProtectedRoute>} />
        <Route path={ROUTES.CODES}               element={<ProtectedRoute allowedRoles={ADMIN}><Codes /></ProtectedRoute>} />
        <Route path={ROUTES.ALERT_CONTROL}       element={<ProtectedRoute allowedRoles={ADMIN}><AlertControl /></ProtectedRoute>} />
        <Route path={ROUTES.STATEMENTS_SETUP}    element={<ProtectedRoute allowedRoles={ADMIN}><StatementsSetup /></ProtectedRoute>} />
        <Route path={ROUTES.SUPERBILLS}          element={<ProtectedRoute allowedRoles={ADMIN}><Superbills /></ProtectedRoute>} />
        <Route path={ROUTES.LABELS}              element={<ProtectedRoute allowedRoles={ADMIN}><Labels /></ProtectedRoute>} />
        <Route path={ROUTES.CUSTOMIZATION}       element={<ProtectedRoute allowedRoles={ADMIN}><Customization /></ProtectedRoute>} />
